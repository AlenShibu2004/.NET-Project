<%@ Page Title="" Language="C#" MasterPageFile="~/ObserverMasterPage.master" AutoEventWireup="true" CodeFile="ObserverNewElection.aspx.cs" Inherits="ObserverNewElection" %>
            ...
            <td colspan="4">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:ButtonField CommandName="start" Text="START" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [NotificationID], [ElectionID], [Subject], [Status] FROM [NotificationTBL]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
