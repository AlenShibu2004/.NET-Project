<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="StudentViewApplication.aspx.cs" Inherits="StudentViewApplication" %>
            ...
            <td colspan="4">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Post" HeaderText="Applied For" />
                        <asp:BoundField DataField="ApplicationDate" HeaderText="Date of Application" />
